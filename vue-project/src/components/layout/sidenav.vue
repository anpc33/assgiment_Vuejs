...
<template>
  <div
    class="w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform"
  >
    <a href="#" class="flex items-center pb-4 border-b border-b-gray-800">
      <h2 class="font-bold text-2xl " style="color: black;">
        AN <span class="bg-[#f84525] text-white px-2 rounded-md font-bold">PH51578</span>
      </h2>
    </a>
    <ul class="mt-4">
      ...
      <li class="mb-1 group">
        ...
        >
          ...
          <RouterLink to="/dashboard" class="text-sm" >Dashboard</RouterLink>
        </a>
      </li>
      ...
      <li class="mb-1 group">
        ...
        <RouterLink to="/listUser" class="text-sm" >User</RouterLink>
      ...
      <li class="mb-1 group">
        ...
        <RouterLink to="/listOrder" class="text-sm" >Đơn hàng</RouterLink>
        </a>
      </li>
      ...
      <li class="mb-1 group">
        ...
        >
          ...
          <RouterLink to="/listCategory" class="text-sm" >Danh mục</RouterLink>
        </a>
      </li>
      ...
      <li class="mb-1 group">
        ...
        >
          ...
          <RouterLink to="/listProducts" class="text-sm" >Sản phẩm</RouterLink>
...
<div class="mb-2"></div>
      ...
      <span class="text-gray-400 font-bold mt-2">BLOG</span>
      <li class="mb-1 group">
        <a
          href=""
